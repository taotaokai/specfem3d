...
#--- local ENU mesh for interface data: moho.dat
...
#--- get Moho depth map on (lon,lat) grid

# now we just make a moho map of constant depth at 50 km
min_lon = 90; max_lon = 130; dlon = 0.05
min_lat = 15; max_lat = 40; dlat = 0.05
...
grd_alt2 = np.ones(grd_lon2.shape) * -50000.0
