...
sem_build_dir=${4:?[arg] need build dir(e.g. specfem3d)}
...
ln -s ${sem_source_dir}/external_libs ./
...
#cp -r $sem_data_dir/meshfem3D_files .
...
# ON TACC with intel mpi
# see "https://portal.tacc.utexas.edu/user-guides/stampede2#programming-knl" for -xCORE-AVX2 -axCORE-AVX512,MIC-AVX512
#./configure FC=ifort MPIFC=mpiifort CC=icc MPI_INC="${TACC_IMPI_INC}" FCFLAGS="-xCORE-AVX2 -axCORE-AVX512,MIC-AVX512" CFLAGS="-xCORE-AVX2 -axCORE-AVX512,MIC-AVX512"
